...
using Clayxels;
public class CollectClassifier : Agent{
   ...
   // remo = (float)selectNum;
    capturer.GetComponent<CaptureAndClassify>().Capture();
    emotion = capturer.GetComponent<CaptureAndClassify>().emotion;
    //getImagePixels = imagepixel.GetComponent<GetImagePixels>();
    //sensor.AddObservation(remo);
    sensor.AddObservation(emotion);
    //obj1
   ...
   //   Debug.Log("deltaTime"+Time.deltaTime);
      //obj1
       ...
       // Debug.Log(controlPosition);
        ...
        Objcolor16.b = Mathf.Abs(rowB16);
         ...
         remo = actionBuffers.ContinuousActions[192];
       //  Debug.Log("Actiontremo"+remo);
        ...
        //transform obj1
        obj1.transform.localPosition = Vector3.MoveTowards(obj1.transform.localPosition,controlPosition1,speed);
        obj1.transform.rotation = Quaternion.RotateTowards(obj1.transform.rotation,Quaternion.Euler(controlRotaion1),speed);
        obj1.transform.localScale =Vector3.MoveTowards(obj1.transform.localScale,controlScale1*5,speed);

          //transform obj2
        obj2.transform.localPosition = Vector3.MoveTowards(obj2.transform.localPosition,controlPosition2,speed);
        obj2.transform.rotation = Quaternion.RotateTowards(obj2.transform.rotation,Quaternion.Euler(controlRotaion2),speed);
        obj2.transform.localScale =Vector3.MoveTowards(obj2.transform.localScale,controlScale2*5,speed);

          //transform obj3
        obj3.transform.localPosition = Vector3.MoveTowards(obj3.transform.localPosition,controlPosition3,speed);
        obj3.transform.rotation = Quaternion.RotateTowards(obj3.transform.rotation,Quaternion.Euler(controlRotaion3),speed);
        obj3.transform.localScale =Vector3.MoveTowards(obj3.transform.localScale,controlScale3*5,speed);

          //transform obj4
        obj4.transform.localPosition = Vector3.MoveTowards(obj4.transform.localPosition,controlPosition4,speed);
        obj4.transform.rotation = Quaternion.RotateTowards(obj4.transform.rotation,Quaternion.Euler(controlRotaion4),speed);
        obj4.transform.localScale =Vector3.MoveTowards(obj4.transform.localScale,controlScale4*5,speed);

          //transform obj5
        obj5.transform.localPosition = Vector3.MoveTowards(obj5.transform.localPosition,controlPosition5,speed);
        obj5.transform.rotation = Quaternion.RotateTowards(obj5.transform.rotation,Quaternion.Euler(controlRotaion5),speed);
        obj5.transform.localScale =Vector3.MoveTowards(obj5.transform.localScale,controlScale5*5,speed);

          //transform obj6
        obj6.transform.localPosition = Vector3.MoveTowards(obj6.transform.localPosition,controlPosition6,speed);
        obj6.transform.rotation = Quaternion.RotateTowards(obj6.transform.rotation,Quaternion.Euler(controlRotaion6),speed);
        obj6.transform.localScale =Vector3.MoveTowards(obj6.transform.localScale,controlScale6*5,speed);

          //transform obj7
        obj7.transform.localPosition = Vector3.MoveTowards(obj7.transform.localPosition,controlPosition7,speed);
        obj7.transform.rotation = Quaternion.RotateTowards(obj7.transform.rotation,Quaternion.Euler(controlRotaion7),speed);
        obj7.transform.localScale =Vector3.MoveTowards(obj7.transform.localScale,controlScale7*5,speed);

          //transform obj8
        obj8.transform.localPosition = Vector3.MoveTowards(obj8.transform.localPosition,controlPosition8,speed);
        obj8.transform.rotation = Quaternion.RotateTowards(obj8.transform.rotation,Quaternion.Euler(controlRotaion8),speed);
        obj8.transform.localScale =Vector3.MoveTowards(obj8.transform.localScale,controlScale8*5,speed);

          //transform obj9
        obj9.transform.localPosition = Vector3.MoveTowards(obj9.transform.localPosition,controlPosition9,speed);
        obj9.transform.rotation = Quaternion.RotateTowards(obj9.transform.rotation,Quaternion.Euler(controlRotaion9),speed);
        obj9.transform.localScale =Vector3.MoveTowards(obj9.transform.localScale,controlScale9*5,speed);

          //transform obj10
        obj10.transform.localPosition = Vector3.MoveTowards(obj10.transform.localPosition,controlPosition10,speed);
        obj10.transform.rotation = Quaternion.RotateTowards(obj10.transform.rotation,Quaternion.Euler(controlRotaion10),speed);
        obj10.transform.localScale =Vector3.MoveTowards(obj10.transform.localScale,controlScale10*5,speed);

          //transform obj11
        obj11.transform.localPosition = Vector3.MoveTowards(obj11.transform.localPosition,controlPosition11,speed);
        obj11.transform.rotation = Quaternion.RotateTowards(obj11.transform.rotation,Quaternion.Euler(controlRotaion11),speed);
        obj11.transform.localScale =Vector3.MoveTowards(obj11.transform.localScale,controlScale11*5,speed);

          //transform obj12
        obj12.transform.localPosition = Vector3.MoveTowards(obj12.transform.localPosition,controlPosition12,speed);
        obj12.transform.rotation = Quaternion.RotateTowards(obj12.transform.rotation,Quaternion.Euler(controlRotaion12),speed);
        obj12.transform.localScale =Vector3.MoveTowards(obj12.transform.localScale,controlScale12*5,speed);

          //transform obj13
        obj13.transform.localPosition = Vector3.MoveTowards(obj13.transform.localPosition,controlPosition13,speed);
        obj13.transform.rotation = Quaternion.RotateTowards(obj13.transform.rotation,Quaternion.Euler(controlRotaion13),speed);
        obj13.transform.localScale =Vector3.MoveTowards(obj13.transform.localScale,controlScale13*5,speed);

          //transform obj14
        obj14.transform.localPosition = Vector3.MoveTowards(obj14.transform.localPosition,controlPosition14,speed);
        obj14.transform.rotation = Quaternion.RotateTowards(obj14.transform.rotation,Quaternion.Euler(controlRotaion14),speed);
        obj14.transform.localScale =Vector3.MoveTowards(obj14.transform.localScale,controlScale14*5,speed);

          //transform obj15
        obj15.transform.localPosition = Vector3.MoveTowards(obj15.transform.localPosition,controlPosition15,speed);
        obj15.transform.rotation = Quaternion.RotateTowards(obj15.transform.rotation,Quaternion.Euler(controlRotaion15),speed);
        obj15.transform.localScale =Vector3.MoveTowards(obj15.transform.localScale,controlScale15*5,speed);

          //transform obj16
        obj16.transform.localPosition = Vector3.MoveTowards(obj16.transform.localPosition,controlPosition16,speed);
        obj16.transform.rotation = Quaternion.RotateTowards(obj16.transform.rotation,Quaternion.Euler(controlRotaion16),speed);
        obj16.transform.localScale =Vector3.MoveTowards(obj16.transform.localScale,controlScale16*5,speed);
    ...
    //  Debug.Log(distanceBetweenObject16);
     ...
     || Mathf.Abs(distanceBetweenObject13) > 3f || Mathf.Abs(distanceBetweenObject14) > 3f ||Mathf.Abs(distanceBetweenObject15) > 3f || Mathf.Abs(distanceBetweenObject16) > 3f)
       ...
       emotion += 1.0f;
       emotion = emotion / 10.0f;

       float test = System.Math.Abs(emotion - remo);
