...
using Clayxels;
public class CollectClassifier2 : Agent{
   
    public float remoControl;
    public float emotionControl;
  ...
  //  int selectNum = Random.Range(0,6);
   // remo = (float)selectNum;
    ...
    // Debug.Log("HajimenoEmotion"+emotion);
     //Debug.Log("HajimenoRemo"+remo);
    //getImagePixels = imagepixel.GetComponent<GetImagePixels>();
    //
    //sensor.AddObservation(remo);
    //Debug.Log("sensor"+remo);
    ...
    {// //Debug.Log("enter OnActionReceived");
      ...
      //  remo = actionBuffers.ContinuousActions[192];
      //  emotion = actionBuffers.ContinuousActions[193];
...
//Heuristic Mode input num to emotion
 public void GetEmotion(){

 if(Input.GetKey(KeyCode.Alpha0))
 {
     emotionControl = 0f;
    // //Debug.Log("emotion 0 angr");
 }
 if(Input.GetKey(KeyCode.Alpha1))
 {
     emotionControl = 1f;
     ////Debug.Log("emotion 1 disgust");
 }
 if(Input.GetKey(KeyCode.Alpha2))
 {
     emotionControl = 2f;
    // //Debug.Log("emotion 2 happy");
 }
 if(Input.GetKey(KeyCode.Alpha3))
 {
     emotionControl = 3f;
    // //Debug.Log("emotion 3 neutral");
 }
 if(Input.GetKey(KeyCode.Alpha4))
 {
     emotionControl = 4f;
    // //Debug.Log("emotion 4 sad");
 }
 if(Input.GetKey(KeyCode.Alpha5))
 {
     emotionControl = 5f;
    // //Debug.Log("emotion 5 surprise");
 }
}
